...
func TestWorksheetValidationsController_GetWorksheetValidations(t *testing.T) {
	...
	request := requests.NewGetWorksheetValidationsRequest(
		remoteName,
		"Sheet1",
...
func TestWorksheetValidationsController_GetWorksheetValidation(t *testing.T) {
	...
	request := requests.NewGetWorksheetValidationRequest(
		remoteName,
		"Sheet1",
		0,
		requests.WithCommonParameter("folder", remoteFolder),
...
func TestWorksheetValidationsController_PutWorksheetValidation(t *testing.T) {
	...
	request := requests.NewPutWorksheetValidationRequest(
		remoteName,
		"Sheet1",
...
func TestWorksheetValidationsController_PostWorksheetValidation(t *testing.T) {
	...
	request := requests.NewPostWorksheetValidationRequest(
		remoteName,
		"Sheet1",
		validation,
		0,
...
func TestWorksheetValidationsController_DeleteWorksheetValidation(t *testing.T) {
	...
	request := requests.NewDeleteWorksheetValidationRequest(
		remoteName,
		"Sheet1",
		0,
		requests.WithCommonParameter("folder", remoteFolder),
...
func TestWorksheetValidationsController_DeleteWorksheetValidations(t *testing.T) {
	...
	request := requests.NewDeleteWorksheetValidationsRequest(
		remoteName,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
		requests.WithCommonParameter("storageName", ""),
