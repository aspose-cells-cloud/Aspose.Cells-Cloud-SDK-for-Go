...
func TestPageSetupController_GetPageSetup(t *testing.T) {
	...
	request := requests.NewGetPageSetupRequest(
		remoteName,
		"Sheet1",
...
func TestPageSetupController_PostPageSetup(t *testing.T) {
	...
	pageSetup.BlackAndWhite = asposecellscloud.BoolPtr(true)
	pageSetup.CenterHorizontally = asposecellscloud.BoolPtr(true)
	pageSetup.CenterVertically = asposecellscloud.BoolPtr(true)
	request := requests.NewPostPageSetupRequest(
		remoteName,
		pageSetup,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
...
func TestPageSetupController_DeleteHeaderFooter(t *testing.T) {
	...
	request := requests.NewDeleteHeaderFooterRequest(
		remoteName,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
		requests.WithCommonParameter("storageName", ""),
...
func TestPageSetupController_GetHeader(t *testing.T) {
	...
	request := requests.NewGetHeaderRequest(
		remoteName,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
		requests.WithCommonParameter("storageName", ""),
...
func TestPageSetupController_PostHeader(t *testing.T) {
	...
	request := requests.NewPostHeaderRequest(
		true,
		remoteName,
		"Update add header",
		1,
...
func TestPageSetupController_GetFooter(t *testing.T) {
	...
	request := requests.NewGetFooterRequest(
		remoteName,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
		requests.WithCommonParameter("storageName", ""),
...
func TestPageSetupController_PostFooter(t *testing.T) {
	...
	request := requests.NewPostFooterRequest(
		true,
		remoteName,
		"add footer script",
		1,
...
func TestPageSetupController_PostFitWideToPages(t *testing.T) {
	...
	request := requests.NewPostFitWideToPagesRequest(
		remoteName,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
		requests.WithCommonParameter("storageName", ""),
...
func TestPageSetupController_PostFitTallToPages(t *testing.T) {
	...
	request := requests.NewPostFitTallToPagesRequest(
		remoteName,
		"Sheet1",
		requests.WithCommonParameter("folder", remoteFolder),
		requests.WithCommonParameter("storageName", ""),
